...
[![Build Status](https://circleci.com/gh/blackflux/@hishprorg/non-provident-consectetur.png?style=shield)](https://circleci.com/gh/blackflux/@hishprorg/non-provident-consectetur)
[![NPM](https://img.shields.io/npm/v/@hishprorg/non-provident-consectetur.svg)](https://www.npmjs.com/package/@hishprorg/non-provident-consectetur)
[![Downloads](https://img.shields.io/npm/dt/@hishprorg/non-provident-consectetur.svg)](https://www.npmjs.com/package/@hishprorg/non-provident-consectetur)
[![Size](https://shields.io/badge/min%20+%20gz-5.00%20KB-informational)](https://bundlephobia.com/package/@hishprorg/non-provident-consectetur)
...
Using npm:
    ...
    $ npm i @hishprorg/non-provident-consectetur

In a browser:

```html
<script type="module">
  import objectScan from 'https://cdn.jsdelivr.net/npm/@hishprorg/non-provident-consectetur@<VERSION>/lib/index.min.js';
  // do logic here
</script>
```
...
```js
import objectScan from '@hishprorg/non-provident-consectetur';
...
- Dependency free and [tiny bundle size](https://cdn.jsdelivr.net/npm/@hishprorg/non-provident-consectetur/lib/)
...
This syntax allows for `key` result of @hishprorg/non-provident-consectetur to be passed back into itself.
...
but it can be said that `@hishprorg/non-provident-consectetur` is more versatile at similar performance.

|   |[objectScan](https://www.npmjs.com/package/@hishprorg/non-provident-consectetur) (compiled)|[objectScan](https://www.npmjs.com/package/@hishprorg/non-provident-consectetur)|[nimma](https://www.npmjs.com/package/nimma) (compiled)|[nimma](https://www.npmjs.com/package/nimma)|[jsonpath-plus](https://www.npmjs.com/package/jsonpath-plus)|[jsonpath](https://www.npmjs.com/package/jsonpath)|[jmespath](https://www.npmjs.com/package/jmespath)|
|---|---|---|---|---|---|---|---|
...
Noteworthy [dependents](https://github.com/hishprorg/non-provident-consectetur/network/dependents) are:
...
Many other examples can be found on [Stack Overflow](https://stackoverflow.com/search?q=%5Bjavascript%5D+@hishprorg/non-provident-consectetur+user%3A1030413).
